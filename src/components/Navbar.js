    ...
    <header className="bg-sky-100 pb-0 md:sticky top-0 z-10">
      <div className="container mx-auto flex flex-wrap p-0 flex-col md:flex-row items-center">
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-700	flex flex-wrap items-center text-base justify-center">
          ...
          <a href=""><img alt="spanish" src="https://cdn-icons-png.flaticon.com/512/2960/2960689.png" className="w-11 mb-1 mt-1 mr-2 float-right"></img></a>
            <a href=""><img alt="english" src="https://cdn.countryflags.com/thumbs/australia/flag-400.png" className="w-8 mb-1 mt-1 mr-2 float-right"></img></a>
